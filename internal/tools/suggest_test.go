...
func TestSuggestTool(t *testing.T) {
	...
	tests := []struct {
		...
		{"mcp__docs__gret", []string{"mcp__docs__greet"}},
		{"mcp__doc__greet", []string{"mcp__docs__greet"}},
		{"mcp__docs__greet2", []string{"mcp__docs__greet"}},
		{"mcp__docs__", []string{"mcp__docs__greet", "mcp__docs__fail"}},
		{"mcp__github__create_iss", []string{"mcp__github__create_issue"}},
		{"completely_unrelated_xyz", nil},
		{"bsh", []string{"bash"}},
	}
