...
var registry = []registryEntry{
	...
	{Name: "/compact", Args: "[model]|off|retry|log", Hint: "compact the conversation now", Category: "Session"},
	...
	{Name: "/export", Args: "[path]", Hint: "write the transcript to a markdown file", Category: "Session"},
	...
	{Name: "/language", Args: "[zh_cn|en]", Hint: "choose the interface language", Category: "Display"},
